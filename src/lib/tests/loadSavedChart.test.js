...
describe('Chart Storage Functions', () => {
    ...
    test('loadSavedChart should return an empty object when no chart exists at the specified index', () => {
    ...
    test('loadSavedChart should return the chart at the specified index', () => {
    ...
    test('loadSavedChart should return the same result on multiple consecutive calls', () => {

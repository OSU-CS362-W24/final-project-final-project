...
describe('Chart Storage Functions', () => {
    ...
    test('saveChart should store/append line plot data with negative values in localStorage', () => {
        // Mock data
        const chartData = [
            { x: -1, y: -10 },
            { x: -2, y: -20 },
    ...
    test('saveChart should store/append scatter plot data with negative values in localStorage', () => {
        // Mock data
        const chartData = [
            { x: -1, y: 6 },
            { x: -2, y: -56 },
    ...
    test('saveChart should store/append bar plot data with valid and invalid values in localStorage', () => {
        // Mock data
        const chartData = [
            { x: 'Category A', y: 'invalid' },
            { x: 'invalid', y: 56 },
            { x: 'Category C', y: 'invalid' }
        ];
    ...
    test('saveChart should store/append bar plot data with negative values in localStorage', () => {
        // Mock data
        const chartData = [
            { x: 'Category A', y: -10 },
            { x: 'Category B', y: -20 },
